...
validator vesting {
  spend(
    ...
    or {
      // CASE 1: Owner ký SAU thời gian lock_until
      and {
        key_signed(tx.extra_signatories, datum.owner),
        valid_after(tx.validity_range, datum.lock_until) 
      },
      // CASE 2: Beneficiary ký TRƯỚC thời gian lock_until
      and {
...
async function main() {
  try {
  // Để lock UTxO, gọi:
  const txHashLock = await lockUtxo(lovelace_lock);
  console.log("Lock tx hash:", txHashLock);
...
phần txhash 
Transaction unlock by beneficiary :
https://preview.cexplorer.io/tx/29073791a62f4f43d964a9231c7825e18763da97a800cae11c7023cd8de7cde7
Transaction unlock by owner :
https://preview.cexplorer.io/tx/14e94d2046d487c1df0eb1c3827ddfe3857d34453f461dbe45de57e00a443f06
